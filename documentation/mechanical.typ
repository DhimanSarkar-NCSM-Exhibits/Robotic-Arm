...
#figure(
  image("assets/19_link_joint_sch.jpg", width: 100%),
...
#figure(
  image("assets/24_metric_screws.jpg", width: 100%),
...
#figure(
  image("assets/22_screw_heads.jpg", width: 100%),
  caption: [Various screw head shapes and drive types.]
)

#figure(
  image("assets/23_screw_types.jpg", width: 100%),
