...
#figure(
  image("assets/02_robot_future.jpg", width: 100%),
...
*Future Engineers* challenges teams to build a self-driving model car that autonomously navigates a track, avoids obstacles, and completes parking tasks — open hardware, any microcontroller, any sensors. Direct preparation for real autonomous vehicle engineering.
...
Full 2026 rules for all categories — including game field specifications, scoring systems, hardware restrictions, and judging rubrics — are published at #link("https://wroindia.org/category-rules-2026/")[_wroindia.org/category-rules-2026_]. Registration is open at #link("https://registration.wroindia.org")[_registration.wroindia.org_]. Note that for 2026, each school is eligible for one free team registration under the Future Innovators category, and the first 15 teams registering under Future Engineers receive free entry.

=== NCSM and NCSD: Supporting Your WRO Journey
...
Through NCSM's *Innovation Hubs*, students gain access to WRO-supported robotics kits, hands-on training in robot design and programming, and structured guidance through the conceptualisation and development of competition strategies. NCSM/NSCD supports student teams through registration fee sponsorship and provides the infrastructure, equipment, and mentorship needed to take a workshop-level idea all the way to a national competition entry — removing financial and logistical barriers that might otherwise prevent talented students from competing.
...
For information on NCSM's WRO support programme, training schedules at your nearest Innovation Hub, and details on sponsored participation, visit #link("https://ncsm.gov.in/activities-main/events/world-robot-olympiad-2026")[_ncsm.gov.in/activities-main/events/world-robot-olympiad-2026_] or speak to your workshop instructor.

#workshop-note[Interested in competing in WRO 2026? Talk to your instructor about NCSM's sponsored participation programme. The official India competition portal is #link("https://wroindia.org")[_wroindia.org_] and the international body is at #link("https://wro-association.org")[_wro-association.org_].]
